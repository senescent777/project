...
#HUOM.20124:nämä kullä tylisi löytyä
[ -d ./buildr/bin ] || mkdir -p ./buildr/bin
[ -d ./buildr/tmp ] || mkdir -p ./buildr/tmp
[ -d ./buildr/source ] || mkdir -p ./buildr/source
[ -d ./buildr/keys ] || mkdir -p  ./buildr/keys
...
#siirretty m ennen run buildr:ia ajettavaksi koska rm buildr/tmp 
#sudo /opt/bin/meshuggah.sh
#HUOM SÖSSIIKÖHÄN m JOTAIN AIEMPIA VIRITYKSIÄ? dsn/t , p/perm ...
...
#TODO:/o/b/p3 siirto scrupts:in alle?
case ${mode} in
	0)
